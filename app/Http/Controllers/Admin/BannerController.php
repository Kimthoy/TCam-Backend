...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'page'     => ['required', Rule::in(['home', 'about','events', 'solutions', 'services', 'contact','partners','careers', 'blog','customers'])],
    ...
    public function update(Request $request, Banner $banner)
    {
        ...
        $data = $request->validate([
            ...
            'page'     => ['sometimes', 'required', Rule::in(['home', 'about', 'solutions', 'services', 'contact','partners','jobs','events', 'blog','customers'])],
    ...
    public function publicBanners(Request $request)
    {
        ...
        $allowedPages = ['home', 'about', 'solutions', 'services', 'contact','events','partners','jobs', 'blog','customers'];
